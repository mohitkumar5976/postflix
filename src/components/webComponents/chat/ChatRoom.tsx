  ...
  return (
    <>
      <div className="relative h-screen flex flex-col">
        <div className="h-14 bg-white flex items-center p-2 gap-2 w-full">
          <div>
            <Link to={"/chat"}>
          ...
          <div className="w-10 h-10 relative">
            <ImageComponent
              ...
              borderRadius={"50%"}
            />
            <span className=" absolute bottom-0.5 right-0.5 w-2 h-2 rounded-full bg-green-400"></span>
          </div>
        ...
        <div className="w-full h-[calc(100vh-100px)] bg-gray-300 overflow-y-auto px-1 pb-3">
          <ChatMessage />
          <ChatMessage />
        ...
        <Box
          className="absolute bottom-0 bg-white px-2 w-full h-14"
